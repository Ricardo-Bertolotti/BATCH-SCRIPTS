...
:: DEFINIR O NOME DO PROGRAMA QUE TERÁ A INICIALIZAÇÃO HABILITADA.
...
REG QUERY "%registryPath%" /V "%programName%" | FINDSTR /R /C:"3" > "%temp%\0_regedit.txt"

:: VARIÁVEL PARA ALOCAR O VALOR BINÁRIO ORIGINAL DO ARQUIVO QUE SERÁ MODIFICADO.
SET /P binaryValor=<"%temp%\0_regedit.txt"

:: DEFINIR UM NOVO VALOR BINÁRIO PARA HABILITAR A INICIALIZAÇÃO DO PROGRAMA DESEJADO.
SET "newBinaryValor=020000000000000000000000"
